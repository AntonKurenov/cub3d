...
int				next_level_map_check(char **map, int len, t_map *map_sp,\
										t_player *player);
...
void			init_engine(t_player *player, t_set *set, t_map *map_specs,\
								char **map);
void			init_img(t_data *new, t_player *player, t_map *map_specs,\
							t_set *set);
...
void			get_sprt_angle(t_data *data, t_spr *spr, double angle,\
								double len);
